package com.example.cvolk.customcontentprovider.providers;
...
import com.example.cvolk.customcontentprovider.helpers.EmployeeDatabaseHelper;
...
public class EmployeeContentProvider extends ContentProvider {
    ...
    String[] tableColumns = {EmployeeContract.COLUMN_ID, EmployeeContract.COLUMN_NAME, EmployeeContract.COLUMN_AGE, EmployeeContract.COLUMN_EMAIL, EmployeeContract.COLUMN_PHONE};
